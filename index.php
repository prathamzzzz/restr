                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        ?>    
                            ...
                            <div class="col-4">
                                <img src='admin/about/<?php echo $fetch["image"] ?> ' alt="" height="150px" width = "200px">
                            </div>
                            <?php } ?>
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src='admin/chef/<?php echo $fetch ["image"]?>' alt="Chef #1" height ="300px" width ="200px">
                        </div>
                        <div class="down-content">
                            <h4><?php echo $fetch ["chefname"]?></h4>
                        ...
                        <form id="contact" action="insert.php" method="post">
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="customername" type="text" id="name" placeholder="Your Name*" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                ...
                <div class="col-lg-12">
                    <div class="row" id="tabs">
                     ...
                     require_once("admin/connection.php");
                      ...
                      $select="SELECT * FROM breakfasttb1";
                      ...
                      while ( $fetch=mysqli_fetch_assoc($query)){
                                  ?>
                                               ...
                                               <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src=' admin/menu/<?php echo $fetch["image"] ?>' width="20%" height="20%" alt="">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                $select="SELECT * FROM breakfasttb2 ";
                                                ...
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src='admin/menu/<?php echo $fetch["image"] ?>' width="22%" height="22%" alt="">
                                                            <h4><?php echo $fetch["title"] ?></h4>
                                                            <p><?php echo $fetch["description"] ?></p>
                                                            <div class="price">
                                                                <h6><?php echo $fetch["price"]?></h6>
                                            ...
                                            <div class="row">
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="tab-item">
                                                            <img src='admin/menu/<?php echo $fetch["image"] ?>'width="125px" height="125px" alt="">
                                                            <h4><?php echo $fetch["title"] ?></h4>
                                                            <p><?php echo $fetch["description"] ?></p>
                                                            <div class="price">
                                                                <h6><?php echo $fetch["price"] ?></h6>
